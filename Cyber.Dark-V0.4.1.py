...
os.system('clear')
print(f"{Fore.GREEN}[+] pip Upgraded ! \n[+] Downlaoded pytz \n[+] colorama Downlaoded !\n[+] Downlaoded requests !\n[+] Downlaoded Tor\n{Fore.RED}[-] Downlaoding telethon")
os.system('pip install telethon')
os.system('clear')
print(f"{Fore.GREEN}[+] pip Upgraded ! \n[+] Downlaoded pytz \n[+] colorama Downlaoded !\n[+] Downlaoded requests !\n[+] Downlaoded Tor\n[+] Downlaoded telethon\n{Fore.RED}[-] Downlaoding telebot")
os.system('pip install pyTelegramBotAPI')
time.sleep(2)
os.system('clear')
import requests , datetime , telebot
...
def info() :
    ...
    Telegram Support --> [@Virus1386 and @Error_1386]
    Version --> [0.3.5]
...
┌─<{iran_time}>[~/Cyber Dark/HTML Downloader]
└──╼ Enter URL ❯❯❯ ''')
    req = requests.post(url).text
    file = open('Cyber-Dark.htm','w')
    file.write(req)
    iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
    con = int(input(f'''{Fore.BLUE}
    
    End !
    Saved the Cyber-Dark.htm :)
...
def telspamer() :
  ...
  /____/ .___/\__,_/_/ /_/ /_/\___/_/     
      /_/    
    ''')
  print(f"{Fore.YELLOW}OK ! Moving to the desired page ...")
  time.sleep(1)
  os.system("clear")
  print(f"{Fore.RED}OK ! Moving to the desired page ...")
  time.sleep(1)
  os.system("clear")
  print(f"{Fore.BLUE}OK ! Moving to the desired page ...")
  time.sleep(1)
  os.system("clear")
  print(f"{Fore.GREEN}OK ! Moving to the desired page ...")
  time.sleep(1)
  os.system("clear")
  print(f"{Fore.CYAN}OK ! Moving to the desired page ...")
  time.sleep(1)
  os.system("clear")
  WORK = 1
  if WORK == 1 :
      ...
      #-----Inputs-----#
      iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
      API_HASH = str(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/Telegram Spamer/API Hash]
└──╼ Enter API Hash ❯❯❯ '''))
      time.sleep(0.5)
      print(f"{Fore.RED}[-] OK , wait a little ... {Fore.LIGHTGREEN_EX}")
      time.sleep(5)
      iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
      API_ID = int(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/Telegram Spamer/API Id]
└──╼ Enter API Id ❯❯❯ '''))
      time.sleep(0.5)
      print(f"{Fore.RED}[-] OK , wait a little ... {Fore.LIGHTGREEN_EX}")
      time.sleep(5)
      iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
      TEXT_SEND = str(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/Telegram Spamer/Text]
└──╼ Enter Text ❯❯❯ '''))
      time.sleep(0.5)
      print(f"{Fore.RED}[-] OK , wait a little ... {Fore.LIGHTGREEN_EX}")
      time.sleep(5)
      iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
      TOKEN = str(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/Telegram Spamer/Bot Token]
└──╼ Enter Bot Token ❯❯❯ '''))
      time.sleep(0.5)
      print(f"{Fore.RED}[-] OK , wait a little ... {Fore.LIGHTGREEN_EX}")
      time.sleep(5)
      iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
      TARGET = str(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/Telegram Spamer/Username Target]
└──╼ Enter Username Target ❯❯❯ '''))
      time.sleep(0.5)
      print(f"{Fore.RED}[-] OK , wait a little ... {Fore.LIGHTYELLOW_EX}")
      time.sleep(5)
      iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
      CHAT_ID = int(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/Telegram Spamer/Chat Id]
└──╼ Enter Your Chat Id ❯❯❯ '''))
      time.sleep(0.5)
      print(f"{Fore.RED}[-] OK , wait a little ... {Fore.LIGHTGREEN_EX}")
      time.sleep(2.5)
      ...
      async def main(event):
          ...
          Channel : @CyberDarker
          Support : @Virus1386 , @Virus1386 and @Error_1386
                    """ , CHAT_ID , SEND_1)
          time.sleep(2)
      bot_spam.run_until_disconnected()
  else :
      pass
def ddos() :
    iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
    IP = str(input(f'''{Fore.RED}
┌─<{iran_time}>[~/Cyber Dark/DDOS Attack/IP]
└──╼ Enter IP for attack ❯❯❯ '''))
    os.system(f'python3 hammer.py -s {IP} -t 200')
#----------Banner----------#
def banner() :
     os.system('clear')
     from datetime import datetime
     from pytz import timezone
     iran_time = datetime.now(timezone("Iran")).strftime("%H:%M:%S")
     work = int(input(f'''{Fore.WHITE}
   ______      __                 ____             __  
  / ____/_  __/ /_  ___  _____   / __ \____ ______/ /__
 / /   / / / / __ \/ _ \/ ___/  / / / / __ `/ ___/ //_/{Fore.BLUE}
/ /___/ /_/ / /_/ /  __/ /     / /_/ / /_/ / /  / ,<   {Fore.RED}
